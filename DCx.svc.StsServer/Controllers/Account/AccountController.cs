...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (button == "register")
            {
                return RedirectToAction("Register", "Register", new 
                {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (_usersRepository.ValidateCredentials(model.Email, model.Password))
                {
        ...
        public async Task<IActionResult> Logout(LogoutInputModel model)
        {
            ...
            if (User?.Identity.IsAuthenticated == true && model.Button == "logout")
            {
            ...
            {
                vm.PostLogoutRedirectUri = model.ReturnUrl;
            }
